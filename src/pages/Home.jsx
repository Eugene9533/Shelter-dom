                ...
                <div class="pets" id="pets">
                    <div class="pets-main">
                        <div class="content">
                            ...
                            <div class="slider">
                                <button class="btn-slider left" onClick={this.prevPets}><img src="icons/Arrow-left.svg" alt="arrow left" /></button>
                                <div class="pets-cards">
                                    <Card idpage="HomePage" idCard={this.state.numCard[0]} />
                                    <Card idpage="HomePage" idCard={this.state.numCard[1]} />
                                    <Card idpage="HomePage" idCard={this.state.numCard[2]} />
                                </div>
                                <button class="btn-slider right" onClick={this.nextPets}><img src="icons/Arrow-right.svg" alt="arrow right" /></button>
                            </div>
